...
public class Moyenne {
		...
		public void affiche() {
			...
			//Appelle de la fonction bigSmallMoyenn() definis tout bas..
		...
		public void bigSmallMoyenne(float tab[]) {
			...
			float max_val=Float.MAX_VALUE; // celui qui compte le plus grand float
			
			float min_val = Float.MIN_VALUE; // celui qui compte le plus petit float
